...
/**
 * Klasa do obslugi lokalnej bazy danych sqlite, zawiera  jedna tabele :Spotkanie
 * @author sliwka
 *
 */
public class SqlHandler {
		...
		/**
		 * Metoda wyciagajaca rekordy z Tabeli Spotkanie
		...
		/**
		 * Metoda wyciagajaca z tabeli rekordy o podanym id
		 * @param id  
		...
		/**
		 * Metoda wyciagajaca z tabeli rekordy o podanym hashu
		 * @param hash
		 * @return
		 */
